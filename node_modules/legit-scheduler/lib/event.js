  ...
  _createClass(Event, [{
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          rest = _objectWithoutProperties(_props3, ['styles', 'isDragging', 'connectDragSource', 'connectDragPreview', 'id', 'title', 'children', 'rowHeight']),
          width = this.state.width,
          resizerStyleMerge = Object.assign({ height: '100%' }, _styles.resizerStyles),
          defaultStyles = { color: '#000', backgroundColor: 'darkgrey' },
          eventStyleMerge = Object.assign({ width: width }, styles || defaultStyles, _styles.eventStyles),
          opacity = isDragging ? 0 : 1,
          boxStyleMerge = Object.assign({ width: width, opacity: opacity }, _styles.boxStyles);
